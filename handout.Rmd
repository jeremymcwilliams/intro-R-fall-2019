...
Just like with Excel, sometimes you may want to add a column of data that is dependent upon calculations of other columns. We can do that in R with the "mutate" function, which is part of the dplyr library. For example, let's add a column to baby.names that inidcates the rate per 1000 
